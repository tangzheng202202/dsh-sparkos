...
if os.path.exists(v2src):
    ...
    check2("v2 only visual decision write endpoint", "/sparkos/visual/decision" in dom2 and all(x not in dom2 for x in ["/sparkos/creation/decision", "/sparkos/visual/retry", "/sparkos/visual/delivery", "/sparkos/visual/queue", "/sparkos/mutate", "/sparkos/editorial/decision", "data-draft-decision"]))
