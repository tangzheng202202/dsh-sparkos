...
function intelCluster(): IntelCluster {
  return {
    clusterId: 'c-20260822-001', topicKey: 't-creation-test', date: '20260822', topic: 'AI 内容工厂创作测试',
...
async function approvedCardFixture() {
  ...
  generateDailyRanking(db, [intelCluster()], '2026-08-22')
